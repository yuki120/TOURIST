...
<body>
	...
	<div id="main">
		...
		<div>
			<h3>削除レビューの内容は以下になります。<br>削除してよろしいですか？</h3>
			<table>
			...
			<div class="btn">
				<input type="button" value="戻る" onclick="submitAction('MasterReviewDeleteAction')" />
				<input type="button" value="削除" onclick="submitAction('MasterReviewDeleteCompleteAction')" />
			</div>
		</div>
	</div>
